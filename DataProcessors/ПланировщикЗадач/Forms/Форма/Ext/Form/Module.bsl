...
Процедура ЗаполнитьЭлементыПланировщика()
	...
	Для каждого СтрРезультат Из Результат Цикл
		...
		НовыйЭлемент.Шрифт		= Новый Шрифт(НовыйЭлемент.Шрифт, "Times new roman", 14);
...
Процедура ВыборДлительностиЗанятияЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("СозданиеЗанятияЗавершение", ЭтаФорма);
...
&НаКлиенте
Процедура СозданиеЗанятияЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
